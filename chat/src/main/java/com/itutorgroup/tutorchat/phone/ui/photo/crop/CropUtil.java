...
class CropUtil {
    ...
    public static boolean copyExifRotation(File sourceFile, File destFile) {
        ...
        try {
            ...
            LogUtil.e("Error copying Exif data, e = " + e.getMessage());
            return false;
        }
    }
    ...
    public static void startBackgroundJob(MonitoredActivity activity,
        ...
        new Thread(new BackgroundJob(activity, job, new LoadingDialog(activity), handler)).start();
    }
    ...
    private static class BackgroundJob extends MonitoredActivity.LifeCycleAdapter implements Runnable {
        ...
        private final Runnable cleanupRunner = new Runnable() {
            public void run() {
                ...
                if (dialog.dialog().getWindow() != null) dialog.dismiss();
            }
        };

        public BackgroundJob(MonitoredActivity activity, Runnable job,
                             LoadingDialog dialog, Handler handler) {
