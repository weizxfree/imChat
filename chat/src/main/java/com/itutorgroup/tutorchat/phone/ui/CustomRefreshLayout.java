 ...
 *
 */
public class CustomRefreshLayout extends SwipeRefreshLayout implements
    ...
    public CustomRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mFooterView = LayoutInflater.from(context).inflate(
                R.layout.footer_grab_order, null, false);

        progressBar = (CircleProgressBar) mFooterView.findViewById(R.id.pull_to_refresh_load_progress);
